                ...
                if has_source:
                    require(
                        binding.get("source") in (
                            ...
                            "shape.q8_1.z_count",
                            "shape.mul_mat_id.k",
                            "shape.mul_mat_id.rows",
                            "shape.mul_mat_id.nexperts",
                            "shape.mul_mat_id.nselected",
                            "shape.mul_mat_id.ntokens",
                            "shape.mul_mat_id.src1_selected_stride",
                            "shape.mul_mat_id.src1_token_stride",
                            "shape.mul_mat_id.idx_token_stride",
                            "shape.mul_mat_id.dst_token_stride",
                            "shape.mul_mat_f16.k",
                            "shape.mul_mat_f16.rows",
                            "shape.mul_mat_f16.cols",
                            "shape.mul_mat_f16.dst_ne2",
                            "shape.mul_mat_f16.dst_ne3",
                            "shape.mul_mat_f16.src0_ne2",
                            "shape.mul_mat_f16.src0_ne3",
                            "shape.mul_mat_f16.src0_stride_row",
                            "shape.mul_mat_f16.src0_stride_ne2",
                            "shape.mul_mat_f16.src0_stride_ne3",
                            "shape.mul_mat_f16.src1_stride_col",
                            "shape.mul_mat_f16.src1_stride_ne2",
                            "shape.mul_mat_f16.src1_stride_ne3",
                            "shape.mul_mat_f16.dst_stride_col",
                            "shape.mul_mat_f16.dst_stride_ne2",
                            "shape.mul_mat_f16.dst_stride_ne3",
                            "shape.cont.ncols",
                            "shape.cont.nrows",
                            "shape.cont.ne1",
                            "shape.cont.ne2",
                            ...
                            "shape.swiglu.ncols",
                            "shape.swiglu.nrows",
                            "shape.sum_rows.ncols",
                            "shape.sum_rows.nrows",
                            "shape.sum_rows.src0_row_stride",
                            "shape.ssm_conv.d_conv",
                            "shape.ssm_conv.ncs",
                            "shape.ssm_conv.d_inner",
                            "shape.ssm_conv.n_t",
                            "shape.ssm_conv.n_s",
                            "shape.ssm_conv.sx_seq_stride",
                            "shape.get_rows.ncols",
                            "shape.get_rows.nrows",
                            "shape.get_rows.src0_nrows",
                            "shape.get_rows.src0_row_stride",
                            "shape.get_rows.idx_row_stride",
                            "shape.get_rows.dst_row_stride",
                            "shape.get_rows_moe.nexperts",
                            "shape.get_rows_moe.nselected",
                            "shape.get_rows_moe.ntokens",
                            "shape.get_rows_moe.src0_token_stride",
                            "shape.get_rows_moe.idx_token_stride",
                            "shape.get_rows_moe.dst_token_stride",
                            "shape.argsort.ncols",
                            "shape.argsort.nrows",
                            "shape.rope.ncols",
                            "shape.rope.n_dims",
                            ...
                            "shape.rope.src0_token_stride",
                            "shape.rope.dst_head_stride",
                            "shape.rope.dst_token_stride",
                            "shape.rope.pos_token_stride",
                            "shape.soft_max.ncols",
                            "shape.soft_max.nrows",
                            "shape.soft_max.ne01",
                            "shape.soft_max.ne02",
                            "shape.soft_max.mask_nb1",
                            "shape.soft_max.mask_nb2",
                            "shape.soft_max.mask_nb3",
                            "shape.soft_max.mask_ne1",
                            "shape.soft_max.mask_ne2",
                            "shape.soft_max.mask_ne3",
                            "shape.set_rows.nc",
                            "shape.set_rows.nr",
                            "shape.set_rows.ne02",
                            "shape.set_rows.ne03",
