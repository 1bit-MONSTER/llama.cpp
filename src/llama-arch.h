...
enum llm_kv {
    ...
    LLM_KV_ZAYA_VLORA_RANK_ATTN,
    LLM_KV_ZAYA_VLORA_RANK_FFN,
...
enum llm_tensor {
    ...
    // ZAYA1-VL: vision-only LoRA (A = down to the rank, B = back up), used on image tokens
    LLM_TENSOR_ZAYA_VLORA_Q_A,
    LLM_TENSOR_ZAYA_VLORA_Q_B,
    LLM_TENSOR_ZAYA_VLORA_K_A,
    LLM_TENSOR_ZAYA_VLORA_K_B,
    LLM_TENSOR_ZAYA_VLORA_V1_A,
    LLM_TENSOR_ZAYA_VLORA_V1_B,
    LLM_TENSOR_ZAYA_VLORA_V2_A,
    LLM_TENSOR_ZAYA_VLORA_V2_B,
    LLM_TENSOR_ZAYA_VLORA_O_A,
    LLM_TENSOR_ZAYA_VLORA_O_B,
    LLM_TENSOR_ZAYA_VLORA_UP_EXPS_A,
    LLM_TENSOR_ZAYA_VLORA_UP_EXPS_B,
    LLM_TENSOR_ZAYA_VLORA_DOWN_EXPS_A,
    LLM_TENSOR_ZAYA_VLORA_DOWN_EXPS_B,
